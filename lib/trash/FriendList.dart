...
//             stream:
//             FirebaseFirestore.instance.collection("user").doc(FirebaseAuth.instance.currentUser!.uid).collection('Friend').get().asStream(),
...
//                       FriendModel.fromMap(snapshot.data?.docs[index].data());
//                       if (userModel.uid ==
...
//   }
//
//   String createRoomId(FriendModel toChatUserModel) {
//     // SmallId_LargeId
//     String roomID = "";
//
//     print(
...
//   }
//
//   checkAndCreateNewRoom(FriendModel toChatUserModel, BuildContext context) async {
